...
ALTER TABLE invoice_detail ADD constraint fk_invoice_detail_order_header FOREIGN KEY (order_detail_id) REFERENCES order_detail (id);
/*Person*/
...
/*class*/
ALTER TABLE category_class ADD constraint fk_category_class_category FOREIGN KEY (category_id) REFERENCES category (id);
...
ALTER TABLE product_classification ADD constraint fk_product_classification_class FOREIGN KEY (class_id) REFERENCES category_class (id);
/*product*/
...
/*price_list_type*/
INSERT INTO price_list_type(price_list_type_name,is_default) VALUES ('Por Defecto',TRUE);
INSERT INTO price_list_type(price_list_type_name,is_default) VALUES ('Frecuente',FALSE);
INSERT INTO price_list_type(price_list_type_name,is_default) VALUES ('Mayorista',FALSE);
